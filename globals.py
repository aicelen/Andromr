...
if platform == "android":
    ...
    def get_android_storage() -> str:
        ...
        if os.path.exists(os.path.join(new_path, "saved_settings.json")) or not os.path.exists(
            os.path.join(old_path, "saved_settings.json")
        ):
...
class AppData:
    def __init__(self):
        ...
        self.hashes = {
            ...
            "encoder_396_int8.zip": "ad4df391c8f6655896f8423836f7d4c718413bc07ba3b64ff8da9384c8d5e80c",
            "decoder_396_int8.zip": "9b9d299ce31a772e4ebbcaa3a8dd96ac57df72992a3add55345103a697b6c968",
        }
    ...
    def _load_settings(self):
        if os.path.exists(self.settings_file_path):
            ...
            try:
                ...
                eprint(
                    f"An error occured during json loading. The file is probably corrupted. Creating a new file"
                )
                pass
