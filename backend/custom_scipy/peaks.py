try:
    ...
    try:
        from backend.custom_scipy.src import peak_finding_utils
    except:
        print('LOADING PEAKS FAILED')
...
def find_peaks(x, height=None, threshold=None, distance=None,
    ...
    if width is not None:
        ...
        properties.update(zip(
            ...
            peak_finding_utils._peak_widths(x, peaks, rel_height, properties['prominences'],
